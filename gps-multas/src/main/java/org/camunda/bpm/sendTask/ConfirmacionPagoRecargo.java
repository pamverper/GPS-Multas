...
public class ConfirmacionPagoRecargo implements ExternalTaskHandler{
	
	//Handler correo
    private static final Logger LOGGER = Logger.getLogger(ConfirmacionPagoRecargo.class.getName());
    
    private MailGenerico mailWorker;

    public ConfirmacionPagoRecargo() {
